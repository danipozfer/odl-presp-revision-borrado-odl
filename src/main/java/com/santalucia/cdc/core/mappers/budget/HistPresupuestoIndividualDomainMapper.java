...
import com.santalucia.arq.ams.odl.presupuestos.historico.individual.api.model.DatoIdentificativoResource;
import com.santalucia.arq.ams.odl.presupuestos.historico.individual.api.model.DomicilioPersResource;
...
public interface HistPresupuestoIndividualDomainMapper {
 ...
 // @Mapping(source = "datoCobro.datoMedioCobro.datoCobroFisico.codNucPobla", target = "datoCobro.datoMedioCobro.datoCobroFisico.codNucleoPobla")
  ...
  DomicilioPersDomain domPersOut(com.santalucia.arq.ams.odl.presupuestos.historico.individual.api.model.DomicilioPersResource in);
  ...
  DatoIdentificativoDomain datoIdenOut(com.santalucia.arq.ams.odl.presupuestos.historico.individual.api.model.DatoIdentificativoResource in);
