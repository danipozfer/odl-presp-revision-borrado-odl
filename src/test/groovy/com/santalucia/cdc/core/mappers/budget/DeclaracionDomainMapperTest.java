...
import com.santalucia.arq.ams.odl.presupuestos.declaraciones.api.model.*;
...
class DeclaracionDomainMapperTest {
  ...
  void toDomain() {
    ...
    DeclaracionDomainMapper mapp = new DeclaracionDomainMapperImpl();
  ...
  void toResource() {
    ...
    DeclaracionDomainMapper mapper = new DeclaracionDomainMapperImpl();
